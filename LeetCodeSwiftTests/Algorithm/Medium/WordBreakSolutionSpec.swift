...
class WordBreakSolutionSpec: QuickSpec {
    ...
    override func spec() {
        describe("Word Break") {
            ...
            it("'fohhemkkaecojceoaejkkoedkofhmohkcjmkggcmnami' should return true") {
                let solution = WordBreakSolution()
                expect(solution.wordBreak("fohhemkkaecojceoaejkkoedkofhmohkcjmkggcmnami",
                        ["kfomka", "hecagbngambii",
